...
class wizard5 extends PureComponent {
  ...
  render() {
    ...
    return (<Page>
        <Navbar>
          <NavTitle>Scelta Strategia 4/7</NavTitle>
        </Navbar>
        <Block strong>
          <BlockTitle>Definisci meglio il tipo di Portafoglio PIR di tuo interesse</BlockTitle>
          <p>
          ...
          Medio/Alto rischio -> Durata media della strategia (7 anni)<br />
          ...
          <p>
          Sei vuoi contenere il rischio al massimo tieni conto i Portafogli Classici con orizzonte temporale a tre anni (inizia di nuovo il percorso)
          </p>
          <List>
            <ListItem
              key="5anni"
          ...
          <Button href="/wizard/4" className="wilbur-button" outline>PRECEDENTE</Button>
